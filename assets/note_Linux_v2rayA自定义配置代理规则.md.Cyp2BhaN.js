import{_ as s,c as n,ao as p,o}from"./chunks/framework.n-91xA-b.js";const u=JSON.parse('{"title":"v2rayA 自定义配置代理规则","description":"","frontmatter":{"title":"v2rayA 自定义配置代理规则","date":"2025-05-14T01:29:31.351Z","length":"465字","time":"2分钟","aside":true,"hash":567703519},"headers":[],"relativePath":"note/Linux/v2rayA自定义配置代理规则.md","filePath":"note/Linux/v2rayA自定义配置代理规则.md"}'),t={name:"note/Linux/v2rayA自定义配置代理规则.md"};function e(l,a,i,c,r,d){return o(),n("div",null,a[0]||(a[0]=[p(`<p>近日回国远程办公，需要使用 vpn 来访问学术资源。之前我一直使用老铁配置的 vpn 服务器，在本地运行 v2rayA 客户端管理流量代理。</p><p>v2rayA 有两种基本模式：</p><ol><li>大陆白名单模式。即默认全局流量走 vpn 中介，只有在白名单内的大陆网站直接连接。</li><li>GFW list 模式。即默认全局流量直接连接，只有被防火长城阻挡的域名走 vpn 中介。</li></ol><p>然而当我直接使用这两种基本模式时，会相应的产生以下问题：</p><ol><li>使用大陆白名单模式时，访问 github 很慢，访问 notion 很快。</li><li>使用 GFW list 模式时，访问 github 很快，访问 notion 很慢。</li></ol><p>在 v2rayA 的官网上找到二者分别的配置如下：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki solarized-dark vp-code" tabindex="0"><code><span class="line"><span># 大陆白名单模式</span></span>
