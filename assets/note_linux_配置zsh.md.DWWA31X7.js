import{_ as s,o as n,c as a,ai as l}from"./chunks/framework.CtuiYkcd.js";const m=JSON.parse('{"title":"配置zsh","description":"","frontmatter":{"title":"配置zsh","date":"2023-11-02T16:58:40.650Z","length":"925字","time":"4分钟","aside":true,"hash":-2066502104},"headers":[],"relativePath":"note/linux/配置zsh.md","filePath":"note/linux/配置zsh.md"}'),t={name:"note/linux/配置zsh.md"},e=l(`<p>系统：ubuntu 22.04</p><p>最近换上了学校配发的新电脑，早听闻zsh大名，趁机配置一番。</p><p>zsh是bash的替代品，因其高度定制化与美观的界面博得程序员欢心。MacOS的默认shell已经更换为zsh。</p><p><a href="https://github.com/ohmyzsh/ohmyzsh" target="_blank" rel="noreferrer">oh-my-zsh</a>是一个配置zsh的开源项目，上面已经有许多预置。我是第一次从bash迁移至zsh，因而直接通过它安装zsh。</p><p>首先运行，安装<code>zsh</code>与<code>oh-my-zsh</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki solarized-dark vp-code"><code><span class="line"><span>sh -c &quot;$(wget -O- https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)&quot;</span></span></code></pre></div><p>然后运行</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki solarized-dark vp-code"><code><span class="line"><span>chsh -s $(which zsh) $(whoami)</span></span></code></pre></div><p>将当前用户的shell程序默认设置为<code>zsh</code>，需要注销并重新登录账户来更新配置。</p><p>重新登录后，打开终端，弹出的便是<code>zsh</code>。</p><p>打开<code>~/.zshrc</code>（类似于<code>bash</code>的<code>.bashrc</code>），只不过zsh特别的还有插件和主题选项。</p><p>配置上借鉴了<a href="https://github.com/antfu/dotfiles/blob/main/.zshrc" target="_blank" rel="noreferrer">antfu</a>，zsh插件与主题生态很丰富，可以自行查询下载。</p><p>在使用spaceship主题的时候我遇到了这个<a href="https://github.com/spaceship-prompt/spaceship-prompt/issues/1193" target="_blank" rel="noreferrer">bug</a>，放在这儿以便诸位。</p><p>spaceship主题需要<a href="https://www.nerdfonts.com/#home" target="_blank" rel="noreferrer">NerdFonts</a>，这里我选择JetBrainsMono Nerd Fonts，这个字体家族字体很多，我选择了Regular那一款安装。然后把终端字体和vscode中的字体都改为&quot;JetBrainsMono Nerd Font&quot;即可。</p><p>最后是我的配置仅供参考。</p><div class="language-zsh"><button title="Copy Code" class="copy"></button><span class="lang">zsh</span><pre class="shiki solarized-dark vp-code"><code><span class="line"><span style="color:#586E75;font-style:italic;"># If you come from bash you might have to change your $PATH.</span></span>
...
<span class="line"><span style="color:#93A1A1;font-weight:bold;">export</span><span style="color:#268BD2;"> LC_ALL</span><span style="color:#859900;">=</span><span style="color:#2AA198;">en_US.UTF-8</span></span>
<span class="line"><span style="color:#93A1A1;font-weight:bold;">export</span><span style="color:#268BD2;"> LANG</span><span style="color:#859900;">=</span><span style="color:#2AA198;">en_US.UTF-8</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#586E75;font-style:italic;"># alias ohmyzsh=&quot;mate ~/.oh-my-zsh&quot;</span></span></code></pre></div>`,16),o=[e];function p(i,c,r,y,h,u){return n(),a("div",null,o)}const d=s(t,[["render",p]]);export{m as __pageData,d as default};
